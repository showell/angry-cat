// Central color palette for Angry Cat.
// Change values here to retheme the whole app.

// Primary interactive color — buttons, headings, labels, and accent borders.
export const primary = "#000080";

// Text drawn on primary-colored surfaces (buttons, title bars).
