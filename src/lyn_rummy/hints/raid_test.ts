...
import { compute_threesomes, Threesome } from "../strategy/threesomes";
...
// that contains KD:1, its own twin. Forbidden.
{
    ...
    const wrap_for_kd2: import("../strategy/threesomes").Threesome = {
        cards: [kd2, ad1, d2],
...
// is in a different stack, not in any source.
{
    ...
    const wrap_for_kd1: import("../strategy/threesomes").Threesome = {
        cards: [kd1, ad1, d2],
        type: CardStackType.PURE_RUN,
    };
