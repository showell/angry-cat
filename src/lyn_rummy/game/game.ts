...
export type { JsonCard } from "../core/card";
export { build_full_double_deck, Card } from "../core/card";
...
const TRICK_BAG = new TrickBag([hand_stacks, direct_play, rb_swap, pair_peel, split_for_set, peel_for_run]);
            ...
            case GameEventType.PLAYER_ACTION:
                if (this.replay_in_progress) {
                    ...
                    const referee_error = validate_game_move({
                        ...
                        hand_cards_played: action.hand_cards_to_release,
                    }, DEFAULT_BOARD_BOUNDS);
                    if (referee_error) {
