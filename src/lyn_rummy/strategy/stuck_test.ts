...
import { successor } from "../core/stack_type";
...
import { solve as graph_solve, STRATEGY_PREFER_RUNS } from "../hints/reassemble_graph";
...
assert.equal(total_rearrange_plays, 171,
    "expected 171 expert plays (split + inject + peel_run + pair + rearrange)");
console.log(`  Stuck turns: ${stuck_turns.length} ✓`);
